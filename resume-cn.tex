...
\begin{itemize}
  ...
  \item 集成 Markdown 插件高亮文档字符串，提供简单的 REPL 支持
\end{itemize}
...
\begin{itemize}[parsep=0.25ex]
  ...
  \item \textbf{Kotlin/Java}:
    ...
    收录，熟悉 JNI 编程、Gradle 构建工具，有使用 Kotlin 编译器分析 Java 代码的经验

  \item \textbf{形式验证}:
    掌握类型层面的编程和依赖类型，正在学习同伦类型论，熟悉 Agda (\textbf{1 年}开发经验，开发组成员之一) 和 F$\star$ 编程语言
  ...
  \item \textbf{开发工具}:
    能适应任何编辑器/操作系统，平常在 Ubuntu 下使用 JetBrains IDE、Emacs，有使用 YouTrack、Jira、GitHub、BitBucket、Coding.net、Tower 等团队协作工具的经验
\end{itemize}
...
\begin{itemize}[parsep=0.25ex]
  ...
  \item 开源贡献: \url{http://ice1000.org/opensource-contributions/} \\
    ...
    \textit{agda, imgui, shields.io, intellij-solidity, IntelliJ-EmmyLua} 等项目提交过功能性的 pull request
